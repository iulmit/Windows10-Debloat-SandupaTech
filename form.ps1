...
$Form.text                       = "Windows 10 Debloat By Sandupa Sandamina"
...
######Label
    ...
    $7zip.width                      = 211
    $7zip.height                     = 30
    $7zip.location                   = New-Object System.Drawing.Point(4,67)
...
######Label
    ...
    $githubdesktop.location          = New-Object System.Drawing.Point(3,102)
...
$Label9.width                    = 25
$Label9.height                   = 10
$Label9.location                 = New-Object System.Drawing.Point(67,142)
...
######Label
    ...
    $brave.width                     = 212
    $brave.height                    = 30
    $brave.location                  = New-Object System.Drawing.Point(4,167)
...
$Label8.width                    = 25
$Label8.height                   = 10
$Label8.location                 = New-Object System.Drawing.Point(41,207)
...
######Label
    $pplayer                         = New-Object system.Windows.Forms.Button
    $pplayer.text                    = "Pot Player"
    $pplayer.width                   = 212
    $pplayer.height                  = 30
    $pplayer.location                = New-Object System.Drawing.Point(3,232)
    $pplayer.Font                    = New-Object System.Drawing.Font('Microsoft Sans Serif',12)
...
######Label
    ...
    $gimp.width                      = 212
    $gimp.height                     = 30
    $gimp.location                   = New-Object System.Drawing.Point(4,267)
...
$Label7.width                    = 25
$Label7.height                   = 10
$Label7.location                 = New-Object System.Drawing.Point(60,302)
...
######Label
    ...
    $vscode.width                    = 211
    $vscode.height                   = 30
    $vscode.location                 = New-Object System.Drawing.Point(4,327)
...
######Label
    ...
    $notepad.width                   = 212
    $notepad.height                  = 30
    $notepad.location                = New-Object System.Drawing.Point(3,362)
...
$Label20.text                     = "Remove Bloatwares"
$Label20.AutoSize                 = $true
$Label20.width                    = 25
$Label20.height                   = 10
$Label20.location                 = New-Object System.Drawing.Point(40,407)
$Label20.Font                     = New-Object System.Drawing.Font('Microsoft Sans Serif',10,[System.Drawing.FontStyle]([System.Drawing.FontStyle]::Bold))
...
######Label
    ...
    $removebloat.location            = New-Object System.Drawing.Point(7,432)
...
#Warning Labels For Removing Bloatware
...
$WarningLabel.location           = New-Object System.Drawing.Point(12,470)
...
$Label5.width                    = 25
$Label5.height                   = 10
$Label5.location                 = New-Object System.Drawing.Point(44,490)
...
######Label
    ...
    $reinstallbloat.location         = New-Object System.Drawing.Point(7,510)
...
######Label
    ...
    $backgroundapps.location         = New-Object System.Drawing.Point(3,313)
...
######Label
    ...
    $cortana.width                   = 205
    $cortana.height                  = 30
    $cortana.location                = New-Object System.Drawing.Point(2,383)
...
######Label
    ...
    $darkmode.width                  = 205
    $darkmode.height                 = 30
    $darkmode.location               = New-Object System.Drawing.Point(4,20)
...
######Label
    ...
    $lightmode.width                 = 205
    $lightmode.height                = 30
    $lightmode.location              = New-Object System.Drawing.Point(3,55)
...
######Label
    ...
    $performancefx.location          = New-Object System.Drawing.Point(3,90)
...
######Label
    ...
    $onedrive.width                  = 205
    $onedrive.height                 = 30
    $onedrive.location               = New-Object System.Drawing.Point(3,244)
...
######Label
    ...
    $ECortana.width                  = 205
    $ECortana.height                 = 30
    $ECortana.location               = New-Object System.Drawing.Point(3,418)
...
######Label
    ...
    $RBackgroundApps.location        = New-Object System.Drawing.Point(3,348)
...
######Label
    ...
    $HTrayIcons.location             = New-Object System.Drawing.Point(3,160)
...
######Label
    ...
    $EClipboardHistory.location      = New-Object System.Drawing.Point(3,488)
...
######Label
    ...
    $ELocation.width                 = 205
    $ELocation.height                = 30
    $ELocation.location              = New-Object System.Drawing.Point(2,453)
...
######Label
    ...
    $InstallOneDrive.location        = New-Object System.Drawing.Point(2,278)
...
######Label
    ...
    $appearancefx.location           = New-Object System.Drawing.Point(4,125)
...
######Label
    ...
    $STrayIcons.location             = New-Object System.Drawing.Point(2,195)
...
$ResultText.height               = 146
$ResultText.location             = New-Object System.Drawing.Point(485,124)
...
$Label10.width                   = 25
$Label10.height                  = 10
$Label10.location                = New-Object System.Drawing.Point(560,60)
$Label10.Font                    = New-Object System.Drawing.Font('Microsoft Sans Serif',24)

$Panel3                          = New-Object system.Windows.Forms.Panel
$Panel3.height                   = 340
$Panel3.width                    = 211
$Panel3.location                 = New-Object System.Drawing.Point(545,290)

$Form.controls.AddRange(@($Panel1,$Panel2,$Label3,$Label15,$PictureBox1,$Label1,$Label4,$Panel3,$ResultText,$Label10,$Label11,$urlfixwinstartup,$urlremovevirus,$urlcreateiso))
$Panel1.controls.AddRange(@($brave,$firefox,$7zip,$sharex,$adobereader,$notepad,$gchrome,$mpc,$pplayer,$powertoys,$winterminal,$vscode,$Label2,$everythingsearch,$sumatrapdf,$vscodium,$imageglass,$gimp,$Label7,$Label8,$Label9,$advancedipscanner,$putty,$etcher,$translucenttb,$githubdesktop,$discord,$autohotkey,$removebloat,$reinstallbloat,$WarningLabel,$Label5,$Label20))
$Panel2.controls.AddRange(@($essentialtweaks,$backgroundapps,$cortana,$actioncenter,$onedrive,$essentialundo,$EActionCenter,$ECortana,$RBackgroundApps,$EClipboardHistory,$ELocation,$InstallOneDrive,$EHibernation,$dualboottime))
$Panel3.controls.AddRange(@($darkmode,$lightmode,$performancefx,$appearancefx,$HTrayIcons,$STrayIcons))
